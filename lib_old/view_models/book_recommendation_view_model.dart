...
import '../utils/book_recommendation_service.dart';
import 'book_list_view_model.dart';
import 'package:flutter/material.dart';
import 'package:logger/logger.dart';

class BookRecommendationsViewModel extends ChangeNotifier {
  final OpenLibraryRecommendationService _recommendationService =
      OpenLibraryRecommendationService();
  ...
  Future<void> loadRecommendationsForBook(BookItem book) async {
    ...
    try {
      final searchResults = await _recommendationService.searchBook(
        book.title,
        book.author,
      );
